...
let s:gui_alert       = '#FFFFFF'
let s:gui_alertbg     = '#5e3747'

let s:gui_alertbg_inactive     = '#38212f'

let s:cterm_inactivebg = 234 " Background for inactive mode
let s:gui_inactivebg   = '#32374a'
let s:cterm_inactivefg = 239 " Foreground for inactive mode
let s:gui_inactivefg   = '#EEEEEE'
...
let g:airline#themes#murmur#palette.normal_modified = {'airline_c': [s:gui_alert, s:gui_alertbg, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur#palette.insert_modified = {'airline_c': [s:gui_alert, s:gui_alertbg, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur#palette.replace_modified = {'airline_c': [s:gui_alert, s:gui_alertbg, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur#palette.visual_modified = {'airline_c': [s:gui_alert, s:gui_alertbg, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur#palette.inactive_modified = {'airline_c': [s:gui_alert, s:gui_alertbg_inactive, s:cterm_inactivefg, s:cterm_inactivebg, 'bold'] ,}
